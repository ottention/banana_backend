...
import com.ottention.banana.response.businesscard.StoredCardContentResponse;
import com.ottention.banana.response.businesscard.StoredCardResponse;
...
public class WalletService {
    ...
    public List<StoredCardResponse> getList(Long id) {
        ...
        storedBusinessCards.forEach(c -> storedCardResponses.add(new StoredCardResponse(c, getByBusinessCardId(c.getBusinessCard().getId()))));

        return storedCardResponses;

    }

    private List<StoredCardContentResponse> getByBusinessCardId(Long id) {
        List<BusinessCardContent> businessCardContents = businessCardContentRepository.findByBusinessCardId(id);
